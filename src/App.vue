...
// Função para filtrar as tarefas com base no filtro atual
...
// Função para atualizar o filtro ao alterar a seleção
  ...
  <div class="container">
    ...
    <form @submit.prevent="cadastraTarefa">
      <div class="row">
        ...
        <div class="col-md-2">
          <select @change="atualizarFiltro" class="form-control">
